    ...
    <PortalLayout title="Client Owner Management" role="admin">
      <div className="w-full max-w-7xl mx-auto space-y-6 select-none font-sans">
        <div className="bg-white p-6 rounded-3xl border-2 border-blue-100 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
          <div>
            <h2 className="text-2xl font-black text-slate-950 font-heading">Client Partner Network</h2>
          ...
          <button
            ...
            className="px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-xl transition-all shadow-blue-glow flex items-center gap-2 btn-touch text-sm shrink-0"
          >
                ...
                {clients.map((client) => {
                  ...
                  return (
                    <tr key={client.id} className="hover:bg-blue-50/50 transition-colors">
                      ...
                      <td className="py-4 px-4 text-slate-600 font-medium">{client.email}</td>
                      ...
                      <td className="py-4 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 font-extrabold rounded-xl text-xs border border-blue-200 transition-all flex items-center gap-1.5"
                          >
                          ...
                          <button
                            ...
                            className="p-2 bg-rose-50 hover:bg-rose-600 text-rose-700 hover:text-white rounded-xl text-xs border border-rose-200 transition-all"
                          >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-md flex items-center justify-center p-6">
          <div className="w-full max-w-lg bg-white border-2 border-blue-200 rounded-3xl p-8 shadow-2xl relative text-slate-950">
            <button onClick={() => setShowModal(false)} className="absolute top-6 right-6 p-2 text-slate-500 hover:text-blue-600">
              <X className="w-6 h-6" />
            </button>
            ...
            <form onSubmit={handleCreateClient} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border-2 border-slate-200 rounded-xl p-3 text-sm text-slate-950 font-bold focus:border-blue-600 focus:bg-white transition-all"
              ...
              <button
                type="submit"
                className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-xl transition-all shadow-blue-glow btn-touch text-base mt-4"
              >
      ...
      {showEditModal && selectedClient && (
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-md flex items-center justify-center p-6">
          <div className="w-full max-w-lg bg-white border-2 border-blue-200 rounded-3xl p-8 shadow-2xl relative text-slate-950">
            <button onClick={() => setShowEditModal(false)} className="absolute top-6 right-6 p-2 text-slate-500 hover:text-blue-600">
              <X className="w-6 h-6" />
            </button>
